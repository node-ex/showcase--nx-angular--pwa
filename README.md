...
pnpm exec nx format:check --projects app-angular-1

# Run format fixing for a single project
pnpm exec nx format:write --projects app-angular-1
...
pnpm exec nx run app-angular-1:type-check
# For prettier output
pnpm exec tsc --build --incremental ./apps/app-angular-1/tsconfig.json

# Type check a single project (does not work well)
pnpm exec tsc -p ./apps/app-angular-1/tsconfig.json
...
pnpm exec nx run app-angular-1:lint

# Fix auto-fixable lint errors for a single project
pnpm exec nx run app-angular-1:lint --fix=true
...
pnpm exec nx run-many --target=lint --projects=app-angular-1,app-angular-2

# Run lint checking in specific folder only (does not work in @nx/eslint v19.5.1)
pnpm exec nx run app-angular-1:lint --lintFilePatterns 'apps/app-angular-1/src/**/*'
...
pnpm exec nx test app-angular-1

# Run tests for all apps
pnpm exec nx run-many -t test

# Run tests for multiple apps
pnpm exec nx run-many -t test -p app-angular-1 app-angular-2
